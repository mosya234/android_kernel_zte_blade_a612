...
/*ZTE_MODIFY, zhangbo change for printk time msg, start*/
#ifdef CONFIG_PRINTK_TIME_WALL_TIME
#include <linux/rtc.h>
u64 local_clk_to_walltime(u64 localtime);
#endif
/*ZTE_MODIFY, zhangbo change for printk time msg, end*/
...
#define __LOG_BUF_LEN (1 << (CONFIG_LOG_BUF_SHIFT+3))//max is 21
#else
