...
#define  GPIO_EXT_SPKAMP_EN_PIN    120   /*chenyu add for AW8736 PA output power mode3 control */
...
#define SPK_WARM_UP_TIME        (25)	/* unit is ms */
...
#endif
	if (enable) {
		pr_debug("chenyu Ext_Speaker_Amp_Change ON+\n");
...
#else
	//*chenyu add for AW8755 PA output power mode3 control */*chenyu add for AW8736 PA output power mode3 control begin */
	...
	/*chenyu add for AW8755 PA output power mode3 control end*/
...
#else
	/*chenyu add for AW8755 PA output power mode3 control begin*/
		//AudDrv_GPIO_EXTAMP_Select(true);
		//AudDrv_GPIO_EXTAMP2_Select(true);
		pr_debug("chenyu Ext_Speaker_Amp_Change ON set GPIO\n");
