...
{	
		int  i4RetValue = 0;	
		char puSendCmd1[2]={(char)(0xEC),(char)(0xA3)};//Ringing OFF	
		char puSendCmd2[2]={(char)(0xA1),(char)(0x0D)};//DLC Mode MCLK[1:0]=b'01	
		char puSendCmd3[2]={(char)(0xF2),(char)(0x00)};//T_SRC[4:0]=b'0000 	
		char puSendCmd4[2]={(char)(0xDC),(char)(0x51)};//Ringing ON	
		LOG_INF("init_setting start 160919!!\n");	
		...
		LOG_INF("init_setting end 160919!!\n");	
	return 0;
}
