...
static int pmic_mt_suspend(struct platform_device *dev, pm_message_t state)
{
	...
	/*ZTE_MODIFY, homekey as volume key, disable interrupt while suspend, start*/
	pmic_enable_interrupt(1, 0, "PMIC");
	pmic_enable_interrupt(3, 0, "PMIC");
	pr_err("pmic_mt_suspend: volume up key disabled\n");
	/*ZTE_MODIFY, homekey as volume key, disable interrupt while suspend, end*/
...
static int pmic_mt_resume(struct platform_device *dev)
{
	...
	pmic_enable_interrupt(1, 1, "PMIC");
	pmic_enable_interrupt(3, 1, "PMIC");
	pr_err("pmic_mt_resume: volume up key enabled\n");
	/*ZTE_MODIFY, homekey as volume key, disable interrupt while suspend, end*/
