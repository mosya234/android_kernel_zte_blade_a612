...
static struct i2c_board_info __initdata i2c_fan5405={ I2C_BOARD_INFO("fan5405", 0xD5>>1)};
...
{
	int ret = 0;
	battery_log(BAT_LOG_CRTI, "[fan5405_init] init start. i2c num=%d\n", fan5405_BUSNUM);
