...
#ifdef BUILD_LK	
	dprintf(0,"%s, F10 dijing ili9881c boe , pin_lcd_id0= %d  pin_lcd_id1 is 0x%x \n", __func__, pin_lcd_id0,pin_lcd_id1);
#else
	printk("%s, F10 dijing ili9881c boe , pin_lcd_id0= %d  pin_lcd_id1 is 0x%x \n", __func__, pin_lcd_id0,pin_lcd_id1);
#endif
	if ( 1== pin_lcd_id0 && 1== pin_lcd_id1)
	{
		return 1;
	}
	else 
...
{
#ifdef BUILD_LK
	dprintf(0,"%s,lk lcm_init:dijing ili9881c\n", __func__);
#else
...
{	
    ...
    SET_RESET_PIN(0);
    #ifdef BUILD_LK
	dprintf(0,"%s,lk :dijing ili9881c 10ms\n", __func__);
    #else
