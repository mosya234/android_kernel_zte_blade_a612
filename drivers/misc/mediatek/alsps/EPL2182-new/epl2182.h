...
#define EPL_H_GAIN			       (0)
#define EPL_M_GAIN			       (1)
#define EPL_L_PS_GAIN			(2)
#define EPL_L_ALS_GAIN			(3)
#define EPL_AUTO_ALS_GAIN		(2)

// regValue for Reg1
#define EPL_8BIT_ADC		(0<<0)
#define EPL_10BIT_ADC		(1<<0)
#define EPL_12BIT_ADC		(2<<0)
#define EPL_14BIT_ADC		(3<<0)
#define EPL_PST_1_TIME		(0 << 2)
#define EPL_PST_4_TIME		(1 << 2)
#define EPL_PST_8_TIME		(2 << 2)
#define EPL_PST_16_TIME		(3 << 2)
#define EPL_ALS_INTT_512     (7 << 4)
#define EPL_PS_INTT_80         (4 << 4)

// regValue for Reg7
#define EPL_C_RESET			(0 << 2)
#define EPL_C_START_RUN	(1 << 2)
#define EPL_C_P_UP			((0 << 1)|EPL_C_START_RUN)
#define EPL_C_P_DOWN		((1 << 1)|EPL_C_START_RUN)
#define EPL_DATA_LOCK_ONLY 	(1 << 0)
#define EPL_DATA_UNLOCK_ONLY 	(0 << 0)
#define EPL_DATA_LOCK		       (EPL_DATA_LOCK_ONLY|EPL_C_START_RUN)
#define EPL_DATA_UNLOCK		(EPL_DATA_UNLOCK_ONLY|EPL_C_START_RUN)

// regValue for Reg0xa 0xb
...
#define EPL_INT_BINARY			(0<<0)
#define EPL_INT_DISABLE			(2<<0)
#define EPL_INT_ACTIVE_LOW		(3<<0)
#define EPL_INT_FRAME_ENABLE	(1<<2)
