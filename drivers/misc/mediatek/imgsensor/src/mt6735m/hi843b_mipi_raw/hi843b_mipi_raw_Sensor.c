...
#define HI843B_OTP_SUPPORT
#ifdef HI843B_OTP_SUPPORT
extern void Hi843bOTPSetting(void);
extern void HI843bOTPExit(void);
...
write_cmos_sensor(0x0a04, 0x017a); //modified by lifengxiang@wind-mobi.com
...
write_cmos_sensor(0x0026, 0x0048); 
write_cmos_sensor(0x002c, 0x09d7); //09d8
...
write_cmos_sensor(0x0002, 0x0000); 
write_cmos_sensor(0x0a02, 0x0100); 
write_cmos_sensor(0x0a04, 0x015a); //modified by lifengxiang@wind-mobi.com
write_cmos_sensor(0x0036, 0x0070); 
write_cmos_sensor(0x0038, 0x7000); 
write_cmos_sensor(0x004e, 0x7070); 
write_cmos_sensor(0x075a, 0x0000); 
...
write_cmos_sensor(0x0002, 0x0000); 
write_cmos_sensor(0x0a02, 0x0100); 
write_cmos_sensor(0x0a04, 0x0178); //modified by lifengxiang@wind-mobi.com
write_cmos_sensor(0x0036, 0x0070); 
write_cmos_sensor(0x0038, 0x7000); 
write_cmos_sensor(0x004e, 0x7070); 
write_cmos_sensor(0x075a, 0x0000); 
